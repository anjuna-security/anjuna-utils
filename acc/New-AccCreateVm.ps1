...
.\New-AccCreateVm.ps1 -Subscription <SUB_NAME_OR_ID> -ResourceGroupName <EXISTING_OR_NEW> -StorageAccountName <EXISTING_OR_NEW> -AccImage acc-ubuntu-16-04 -VMName <NAME_OF_VM> -VmUserName <NAME_OF_USER>

Create an ACC Linux VM with specified password
.\New-AccCreateVm.ps1 -Subscription <SUB_NAME_OR_ID> -ResourceGroupName <EXISTING_OR_NEW> -StorageAccountName <EXISTING_OR_NEW> -AccImage acc-ubuntu-16-04 -VMName <NAME_OF_VM> -VmUserName <NAME_OF_USER> -VmPassword <PASSWORD>

Create an ACC Dev VM with specified password
.\New-AccCreateVm.ps1 -Subscription <SUB_NAME_OR_ID> -ResourceGroupName <EXISTING_OR_NEW> -StorageAccountName <EXISTING_OR_NEW> -AccImage acc-ubuntu-dev -VMName <NAME_OF_VM> -VmUserName <NAME_OF_USER> -VmPassword <PASSWORD>

Create an ACC Windows VM (If password is not specified, then script will prompt for password)
.\New-AccCreateVm.ps1 -Subscription <SUB_NAME_OR_ID> -ResourceGroupName <EXISTING_OR_NEW> -StorageAccountName <EXISTING_OR_NEW> -AccImage acc-windows-server-2016-vs -VMName <NAME_OF_VM> -VmUserName <NAME_OF_USER> -VmPassword <PASSWORD>
...
param(
    ...
    [Parameter(Mandatory=$true)]
    [ValidateSet("acc-ubuntu-16-04", "acc-windows-server-2016-vs", "acc-ubuntu-dev")]
    [string]$AccImage,
...
Write-Log -Type INFO -Text "VM Created: $VmName, Public IP: $($Vm_Object.publicIpAddress)`r`n$Vm_Object"
